...
namespace gestion_de_notes.Controllers
{
    public class MatieresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMatiere,NomMatiere,Coefficient")] Matiere matiere)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMatiere,NomMatiere,Coefficient")] Matiere matiere)
        {
